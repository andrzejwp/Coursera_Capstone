...
\centering{\begin{tabular}{llrrllr}
\toprule
...
\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_24_0.png}\end{center}\end{figure}

\begin{lstlisting}[language={},postbreak={},numbers=none,xrightmargin=7pt,breakindent=0pt,aboveskip=5pt,belowskip=5pt]
<folium.folium.Map at 0x7f507cf55c50>
\end{lstlisting}
...
\begin{lstlisting}[language={},postbreak={},numbers=none,xrightmargin=7pt,breakindent=0pt,aboveskip=5pt,belowskip=5pt]
<folium.folium.Map at 0x7f507f8a8d68>
\end{lstlisting}

\hypertarget{explore-highest-rated-restaurants-by-district}{%
\subsection{Explore highest rated restaurants by
district}\label{explore-highest-rated-restaurants-by-district}}

As the first step to choose the best place to dine we will look into how
ratings per district are distributed.

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_0.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_1.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_2.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_3.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_4.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_5.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_6.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_7.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_8.png}\end{center}\end{figure}

\begin{figure}[H]\begin{center}\adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{capstone_project_files/output_30_9.png}\end{center}\end{figure}

\begin{table}[H]
\caption{Venues count by district and rating count}\label{tbl:pivotRatingByDistrict}
\centering
\begin{adjustbox}{max width=\textwidth}\rowcolors{2}{gray!20}{white}
